...
. `dirname $0`/setEnvHs_uat_WC-1.sh
...
$JAVA_HOME/bin/java -Djboss.ejb.client.properties.file.path=${PROPERTIES_FILE} -Dlog4j.configuration=file:${CONFIG}/log4j_KB.properties -cp $CLASSPATH $BATCH_CLASS $PROPERTIES_FILE 2 ${HOUSEKEEPING_DATE}
