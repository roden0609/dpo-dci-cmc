...
JAVA_HOME=/bd-ogcmr/bduat/java/jdk/
LIB=/bd-ogcmr/bduat/cmc/support/client-rm3/lib
...
CLIENT_PROG=hk.gov.dpo.mars_cmc.cmc.client.maintainmessage.MaintainMessageClientTest

PROPERTY_FILE=./config/kc_maint_message.properties
