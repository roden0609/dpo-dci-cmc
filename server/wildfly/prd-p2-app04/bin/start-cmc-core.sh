...
SERVER_BASE_DIR=/bd-ogcmr/prd/jboss/wildfly/cmc-core
JAVA_CUSTOM_DIR=/bd-ogcmr/prd/java/customise
...
`dirname $0`/standalone.sh -c standalone-cmc-core.xml -b 172.16.131.14 -bmanagement=172.16.131.14 -Djboss.server.base.dir=$SERVER_BASE_DIR > /dev/null &
