 ...
 */
public class ServiceProvider extends ServiceProvider_CT 
implements java.io.Serializable
{
    ...
    public ServiceProvider() 
     {
        super();
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.ServiceProvider()
    ...
    public static hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.ServiceProvider_CT unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.ServiceProvider_CT) Unmarshaller.unmarshal(hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.ServiceProvider.class, reader);
