 ...
 */
public class TransactionDescriptor extends Transaction_CTDescriptor {
    ...
    public TransactionDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new Transaction_CTDescriptor());
        nsURI = "http://ws.mygovhk.gov.hk/schema/RPT-CMC-06-D.xsd";
        xmlName = "Transaction";
        elementDefinition = true;
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.TransactionDescriptor()
    ...
    {
        return hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Transaction.class;
