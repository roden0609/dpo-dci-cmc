...
public class IAS11DReport implements IReportImplement {

    private static Log logger = LogFactory.getLog(IAS11DReport.class);
    ...
    public List<ReportResult> generateReport(AdmRptInfo_ admRptInfo, Map<String, String> paramMap) throws Exception {
        ...
        try {
            ...
            if (logger.isInfoEnabled())
                logger.info("IAS11DReport successful reportingDateStr[" + reportingDateStr + "], requestDate["
