 ...
 */
public class DueAmount extends DueAmount_CT 
implements java.io.Serializable
{
    ...
    public DueAmount() 
     {
        super();
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.DueAmount()
    ...
    public static hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.DueAmount_CT unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.DueAmount_CT) Unmarshaller.unmarshal(hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.DueAmount.class, reader);
