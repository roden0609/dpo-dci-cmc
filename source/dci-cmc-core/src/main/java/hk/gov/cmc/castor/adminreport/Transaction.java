 ...
 */
public class Transaction extends Transaction_CT 
implements java.io.Serializable
{
    ...
    public Transaction() 
     {
        super();
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Transaction()
    ...
    public static hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Transaction_CT unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Transaction_CT) Unmarshaller.unmarshal(hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Transaction.class, reader);
