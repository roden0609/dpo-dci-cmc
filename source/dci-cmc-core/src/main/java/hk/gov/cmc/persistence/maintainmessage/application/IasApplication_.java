...
public class IasApplication_ implements Serializable {
    ...
    private String detailTc = null;
    private String detailSc = null;
    ...
    private boolean dirty_titleEn = false;
    private boolean dirty_titleTc = false;
    private boolean dirty_titleSc = false;
    private boolean dirty_detailEn = false;
    private boolean dirty_detailTc = false;
    private boolean dirty_detailSc = false;
