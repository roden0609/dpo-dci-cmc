...
public class MessageResponse_CTDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MessageResponse_CTDescriptor() {
        ...
        //-- validation code for: recipientID
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
        ...
        //-- validation code for: tranResultCode
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
        ...
        //-- validation code for: tranResultMessage
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
            org.exolab.castor.xml.validators.StringValidator typeValidator;
            typeValidator = new org.exolab.castor.xml.validators.StringValidator();
