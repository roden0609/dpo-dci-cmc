 ...
 */
public class ReportDescriptor extends Report_CTDescriptor {
    ...
    public ReportDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new Report_CTDescriptor());
        nsURI = "http://ws.mygovhk.gov.hk/schema/RPT-CMC-06-D.xsd";
        xmlName = "Report";
        elementDefinition = true;
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.ReportDescriptor()
    ...
    {
        return hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Report.class;
