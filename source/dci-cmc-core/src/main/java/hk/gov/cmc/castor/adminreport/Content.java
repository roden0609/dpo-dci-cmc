 ...
 */
public class Content extends Content_CT 
implements java.io.Serializable
{
    ...
    public Content() 
     {
        super();
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Content()
    ...
    public static hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Content_CT unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Content_CT) Unmarshaller.unmarshal(hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.Content.class, reader);
