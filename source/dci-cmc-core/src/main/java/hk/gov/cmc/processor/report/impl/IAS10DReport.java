...
public class IAS10DReport implements IReportImplement {

    private static Log logger = LogFactory.getLog(IAS10DReport.class);
    ...
    public List<ReportResult> generateReport(AdmRptInfo_ admRptInfo, Map<String, String> paramMap) throws Exception {
        ...
        try {
            ...
            if (logger.isInfoEnabled())
                logger.info("IAS10DReport successful reportingDateStr[" + reportingDateStr + "], requestDate["
