 ...
 */
public class ToDoItem extends ToDoItem_CT 
implements java.io.Serializable
{
    ...
    public ToDoItem() 
     {
        super();
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.ToDoItem()
    ...
    public static hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.ToDoItem_CT unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.ToDoItem_CT) Unmarshaller.unmarshal(hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.ToDoItem.class, reader);
