 ...
 */
public class MetaDataDescriptor extends MetaData_CTDescriptor {
    ...
    public MetaDataDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new MetaData_CTDescriptor());
        nsURI = "http://ws.mygovhk.gov.hk/schema/MaintainMessageRequest.xsd";
        xmlName = "MetaData";
        elementDefinition = true;
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.MetaDataDescriptor()
    ...
    {
        return hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.MetaData.class;
