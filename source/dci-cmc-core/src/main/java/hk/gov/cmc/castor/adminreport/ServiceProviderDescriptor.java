 ...
 */
public class ServiceProviderDescriptor extends ServiceProvider_CTDescriptor {
    ...
    public ServiceProviderDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new ServiceProvider_CTDescriptor());
        nsURI = "http://ws.mygovhk.gov.hk/schema/RPT-CMC-06-D.xsd";
        xmlName = "ServiceProvider";
        elementDefinition = true;
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.ServiceProviderDescriptor()
    ...
    {
        return hk.gov.ogcio.mars_cmc.cmc.castor.adminreport.ServiceProvider.class;
