 ...
 */
public class MetaData extends MetaData_CT 
implements java.io.Serializable
{
    ...
    public MetaData() 
     {
        super();
    } //-- hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.MetaData()
    ...
    public static hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.MetaData_CT unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.MetaData_CT) Unmarshaller.unmarshal(hk.gov.ogcio.mars_cmc.cmc.castor.maintainmessage.MetaData.class, reader);
