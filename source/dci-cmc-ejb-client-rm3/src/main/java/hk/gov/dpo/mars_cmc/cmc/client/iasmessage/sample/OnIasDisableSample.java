...
public class OnIasDisableSample {

    public static void main(String args[]) {

        try {
            if (args.length != 1) {
                System.out.println("Usage: java " + OnIasDisableSample.class.getName() + " <property file> ");
                System.exit(-1);
            }
            ...
            ScopesMessagingAcknowledgement ack = iasMsgSettingClient.disable(openIdList);
