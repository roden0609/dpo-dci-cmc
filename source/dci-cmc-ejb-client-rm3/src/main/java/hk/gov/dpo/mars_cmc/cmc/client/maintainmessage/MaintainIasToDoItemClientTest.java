...
public class MaintainIasToDoItemClientTest {

    public MaintainIasToDoItemClientTest() {
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            if (args.length != 1) {
                System.out
                        .println("Usage: java " + MaintainIasToDoItemClientTest.class.getName() + " <property file> ");
                System.exit(-1);
            }
            ...
            for (int i = 1; i <= numberOfTestCase; i++) {
                ...
                MaintainIasToDoItemClientTest maintainIasToDoItemClientTest = new MaintainIasToDoItemClientTest();

                maintainIasToDoItemClientTest.test(properties);
            }
