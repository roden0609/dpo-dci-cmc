...
public class Recipient implements Serializable {
    ...
    public String toString() {
        return "Recipient [m_tranID=" + m_tranID + ", m_idpID=" + m_idpID + ", m_recipientID=" + m_recipientID
                + ", m_itemDate=" + m_itemDate + ", m_action=" + m_action + ", m_correlatedTranID=" + m_correlatedTranID
                + ", m_appRefNum=" + m_appRefNum + ", m_appStatus=" + m_appStatus + ", m_appStatusUpdateDate="
                + m_appStatusUpdateDate + ", m_contactEmail=" + m_contactEmail + ", m_contactNum=" + m_contactNum
                + ", m_miscInfo=" + m_miscInfo + ", m_recipientIDType=" + m_recipientIDType + "]";
    }
